...
public class RecParamControlPanel extends JPanel implements CytoPanelComponent {
	...
	public RecParamControlPanel(CyApplicationManager cyApplicationManagerRef) {
			
		cyApplicationManager =  cyApplicationManagerRef;
		
		btn = new JButton("Add Reconstruction Params");
		btn1 = new JButton("No (i,i) edges");
		btn2 = new JButton("Add all edges");
		btn3 = new JButton("Clean all");
